        ...
        <section>
           <script>
              $(document).ready(function(){
                  loadFarmerProfile(getPortalCookie('_id'),getPortalCookie('_role_type'));
              });
            ...
            <div class="container-fluid">   
                ...
                <div id="timelineProfilePic" class="">
                    ...
                    <a href="#" title="" class="image" id="profile_image"</a>                        
                    ...
                    <div id="pageTab3" class="">	
                      <div id="timelineNav">
                        <ul  class="nav nav-pills"  style="margin-left: 25%">
                            ...
                            <li><a href="#4b" data-toggle="tab">Managers</a>
                            </li>
                        </ul>
                          <a href="#" onclick="javascript:void window.open('ServletViewer?q='+getPortalCookie('_id'),'1461164921372','width=400,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;"><span style="float: right; font-size:1em" class="label badge">Print slip</span></a>
                      </div>
                               ...
                               <div class="row profile-tab">  
                                    <div class = "panel panel-success">
                                       ...
                                       <div class = "panel-body table-responsive" id="personal_info_body">
                                            <table class="table">
                                                    <tbody>
                                                        <tr><td class="bold">Surname</td><td id="surname_data"></td></tr>
                                                        <tr><td class="bold">First Name</td><td id="firstname_data"></td></tr>
                                                        <tr><td class="bold">Middle Name</td><td id="middlename_data"></td></tr>
                                                        <tr><td class="bold">Gender</td><td id="gender_data"></td></tr>
                                                    </tbody> 
                                            </table>                                           
                                       </div>
                                    ...
                                    <div class = "panel panel-success">
                                       ...
                                       <div class = "panel-body table-responsive">
                                            <table class="table">
                                                    <tbody>
                                                        <tr><td class="bold">Phone Number</td><td id="phone_data"></td></tr>
                                                        <tr><td class="bold">Email Address</td><td id="email_data"></td></tr>
                                                        <tr><td class="bold">Contact Address</td><td id="contact_data"></td></tr>
                                                        <tr><td class="bold">Village</td><td id="village_data"></td></tr>
                                    ...
                                    <div class = "panel panel-success">
                                       ...
                                       <div class = "panel-body table-responsive">
                                            <table class="table">
                                                    <tbody>
                                                        <tr><td class="bold">Preferred Language</td><td id="language_data"></td></tr>
                                                        <tr><td class="bold">Education Level</td><td id="education_data"></td></tr>
                                                        <tr><td class="bold">Phone Used</td><td id="phonetype_data"></td></tr>
                                    ...
                                    <div class = "panel panel-success">
                                       ...
                                       <div class = "panel-body table-responsive">
                                            <table class="table">
                                                    <tbody>
                                                        <tr><td class="bold">State</td><td id="state_data"></td></tr>
                                                        <tr><td class="bold">Local Government</td><td id="localgvt_data"></td></tr>
                                                        <tr><td class="bold">Council Ward</td><td id="ward_data"></td></tr>
                                    ...
                                    <div class = "panel panel-success">
                                       ...
                                       <div class = "panel-body table-responsive">
                                         <table class="table">
                                            <tbody>
                                                <tr><td class="bold">Surname</td><td id="kinsurname_data"></td></tr>
                                                <tr><td class="bold">Name</td><td id="kinname_data"></td></tr>
                                                <tr><td class="bold">Phone Number</td><td id="kinphone_data"></td></tr>
                                                <tr><td class="bold">Contact Address</td><td id="kincontact_data"></td></tr>
                                                <tr><td class="bold">Relationship</td><td id="kinrelationship_data"></td></tr>
                                            </tbody>
                                         </table>
                                       </div>
                                ...
                                <div class="content">
                                    <div class="panel panel-success">
                                        <div class="panel-heading">
                                            <h2><i class="fa fa-briefcase fa-3x"></i>Farm Managers</h2>
                                        </div>
                                            <div class="panel-body">
                                                <div class="row">
                                                    <div class="list-group">
