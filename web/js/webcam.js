...
//  $('#post_save_buttons').hide();	
//
//$( "#takeshot" ).click(function() {
//    
//  $('.error').hide();	
//
//   var user_position = $("select#user_position").val();
//
//   if (user_position === "0") {
//
//    $("label#user_position_error").show();
//    $("select#user_position").focus();
//      return false;
//
//    }else{
//        
...
//  $('#post_take_buttons').hide();
//  
//  $('#default_take_buttons').show();	
//    
//    });
//
//$( "#saveshot" ).click(function() {
//    
...
//    		 {     
//                     $("#photo").html('<img src="data:image/jpg;base64,' + data_uri + '"/>');
//                     $('img').fakecrop();                     
//                     $('#first_panel').hide();
//                     $('#form_block').show();
//
...
function take_snapshot() {
    ...
    function showUploadPhotograph(str){
        var xmlhttp;
        ...
        xmlhttp.open("GET","FileServlet?q="+str,true);
        xmlhttp.send();
        }	